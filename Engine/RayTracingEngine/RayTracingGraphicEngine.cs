...
using ConsoleGraphicEngine.Engine.RayTracing.Components.Rendering.ObjectRenderers.Camera;
using ConsoleGraphicEngine.Engine.RayTracing.Components.Rendering.ObjectRenderers.Light;
...
namespace ConsoleGraphicEngine.Engine.RayTracing
{
